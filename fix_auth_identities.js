...
async function main() {
  console.log('=== DÉBUT DE LA RÉSOLUTION DE L AUTHENTIFICATION (GoTrue / Supabase) ===\n');
...
BEGIN   
  ...
  LOOP     
    ...
    -- Nettoyage préventif des identités email orphelines pour cet utilisateur
...
`;
  ...
  if (successCount === testUsers.length) {
    console.log('TOUS LES COMPTES CADRES ET CHEFS D ÉQUIPE SONT PLEINEMENT OPÉRATIONNELS !');
  }
}
